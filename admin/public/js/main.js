(function ($) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ClassicEditor.create(document.querySelector('#content'), {
            language: 'vi',
            ckfinder: {
                uploadUrl: '/ngulongbakery/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images&responseType=json'
            },
            toolbar: {
                items: [
                    'fontfamily',
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        orderStatusSelect.addEventListener('change', function () {
            ...
            } else if (orderStatusSelect.value === 'Đang giao hàng') {
                exportButton.disabled = false;
                exportButton.style.backgroundColor = '#2194E6';
                inExportButton.style.backgroundColor = '#2194E6';
                inExportButton.style.border = 'none';
                inExportButton.innerHTML = `Xác nhận giao hàng`;
            } else if (orderStatusSelect.value === 'Giao hàng thành công') {
                exportButton.disabled = false;
                exportButton.style.backgroundColor = '#2194E6';
                inExportButton.style.backgroundColor = '#2194E6';
                inExportButton.style.border = 'none';
