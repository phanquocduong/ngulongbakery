                  ...
                  ?>
                    <div class='card card-body'>
                      ...
                      <div class='mb-3'>
                        ...
                        <div class="" style="display: flex; margin-top: 30px;"> <a href="index.php?page=products" style="width: 150px;background: red; border: none;" class="btn btn-primary">
                            Quay lại
                          </a><br>
                          <a href="index.php?page=viewEdit_products&id=" style="width: 150px;;margin: 0 10px; border: none;" class="btn btn-primary">
                            sửa sản phẩm
                          </a>
                        </div>
                        </div>
