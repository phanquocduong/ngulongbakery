<header>
    <div class="header-left">
        ...
        <ul class="header-menu">
            ...
            <li class="header-menu__item">
                <a href="index.php?page=collection" class="header-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'collection') ? 'header-menu__item-link--active' : ''?>">
                    SẢN PHẨM
            ...
            <li class="header-menu__item">
                <a href="index.php?page=news" class="header-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'news') ? 'header-menu__item-link--active' : ''?>">TIN TỨC</a>
            </li>
        </ul>
    </div>
    ...
    <div class="header-right">
        <ul class="header-menu">
            <li class="header-menu__item">
                <a href="index.php?page=about" class="header-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'about') ? 'header-menu__item-link--active' : ''?>">GIỚI THIỆU</a>
            </li>
            <li class="header-menu__item">
                <a href="index.php?page=contact" class="header-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'contact') ? 'header-menu__item-link--active' : ''?>">LIÊN HỆ</a>
            </li>
        </ul>
    ...
    <div class="modal-menu" id="modalMenu">
        ...
        <ul class="modal-menu__list">
            ...
            <li class="modal-menu__item"><a class="modal-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'news') ? 'header-menu__item-link--active' : ''?>" href="index.php?page=news">Tin Tức</a></li>
            <li class="modal-menu__item"><a class="modal-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'about') ? 'header-menu__item-link--active' : ''?>" href="index.php?page=about">Giới Thiệu</a></li>
            <li class="modal-menu__item"><a class="modal-menu__item-link <?=(!empty($_GET['page']) && $_GET['page'] == 'contact') ? 'header-menu__item-link--active' : ''?>" href="index.php?page=contact">Liên Hệ</a></li>
        </ul>
    </div>
</header>
