                                        ...
                                        <div class="col l-8 m-12 c-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col l-9 m-9 c-8">
                                                    ...
                                                    <span class="user-information__value"
                                                        >******** <a href="index.php?page=change-password" class="edit-link">Đổi mật khẩu</a></span
                                                    >
                                                    <div class="user-information__value">
                                                        <input
                                                            type="text"
                                ...
                                <?php foreach($data['orders'] as $item): ?>
                                    <div class="order-history-item">
                                            ...
                                            <?php foreach($item['details'] as $detail): ?>
                                                <div class="product-order">
                                                    <div class="product-info">
                                                        <img
                                                            src="public/upload/product/<?=$detail['product_image']?>"
                                                    ...
                                                    <div class="product-price">
                                                        <span class="product-price__current"><?= number_format($detail['unit_price']) ?>đ</span>
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
                                        </div>
                                        <div class="delivery-status">
                                            ...
                                            ?>
                                            <span class="<?= $statusClass ?>"><i class="status-icon fa-solid <?= $statusIcon ?>"></i><?= $statusText ?></span>
                                        </div>
                                        <div class="into-money">
                                            <span class="into-money__order-id">#<?=$item['id']?></span>
                                            <div class="into-money__total">
                                                <span class="into-money__total-label">Thành tiền:</span>
                                                <span class="into-money__total-price"><?= number_format($item['total_amount']) ?>đ</span>
                                            </div>
                                        </div>
                                        <?php if($item['status'] == 'Chờ xác nhận'): ?>
                                            <button onclick="cancelOrder(<?=$item['id']?>)" class="options-btn">Huỷ</button>
                                        <?php elseif($item['status'] == 'Giao hàng thành công'): ?>
                                            <button onclick="openReviewModal(<?=$item['id']?>)" id="openPopupBtn" class="options-btn">Đánh giá</button>
                                        <?php elseif($item['status'] == 'Đã huỷ'): ?>
                                            <button onclick="buyBackOrder(<?=$item['id']?>)" class="options-btn">Mua lại</button>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; ?>
