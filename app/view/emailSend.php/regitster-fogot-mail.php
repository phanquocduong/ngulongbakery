        ...
        <?php if ($Send_user == 'user_register') : ?>
            ...
            <?php elseif ($Send_user == 'user_forgot'): ?>
                <div class="mail-contact">
                    ...
                    <div class="mail-contact-pull-btn-box"><a href="localhost/ngulongbakery/index.php?page=reset-password&code=<?= $code ?>"><button class="btn-mail">Quên mật khẩu</button></a>
                    </div>
                    <div class="mail-contact-pull" style="border: none; padding: 10px 0;">
