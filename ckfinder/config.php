...
$config['backends'][] = array(
    'name' => 'default',
    'adapter' => 'local',
    'baseUrl' => '/ngulongbakery/public/upload/post/images',
    // 'root' => 'D:/laragon/www/ngulongbakery/public/upload/post', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles' => 0777,
    'chmodFolders' => 0755,
